  ...
  return (
    <div className="flex h-full bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
      <div className="flex w-full p-4 space-x-4">
        {/* Chat list */}
        <div className="w-1/3 bg-blue-900 bg-opacity-30 backdrop-filter backdrop-blur-lg rounded-lg shadow-md overflow-hidden">
          <h2 className="text-xl font-semibold p-4 border-b border-blue-800 text-white">Chats</h2>
        ...
        {/* Chat messages */}
        <div className="flex-1 flex flex-col bg-blue-900 bg-opacity-30 backdrop-filter backdrop-blur-lg rounded-lg shadow-md overflow-hidden">
          ...
          <div className="bg-blue-900 bg-opacity-50 p-4 border-t border-blue-800">
            <div className="flex space-x-2">
              <Input
                ...
                className="bg-blue-800 bg-opacity-50 text-white placeholder-blue-300 border-blue-700"
              />
